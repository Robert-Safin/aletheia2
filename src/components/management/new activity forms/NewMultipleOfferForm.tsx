...
export interface NewMultipleOfferFormkikData {
  name: string;
  description: string;
  startDate: string;
  endDate: string;
...
const NewMultipleOfferForm: FC<Props> = (props) => {
  ...
  return (
    <Formik
      initialValues={
        {
          ...
          onSaturday: false,
          onSunday: false,
        } as NewMultipleOfferFormkikData
      }
      onSubmit={async (values, { setSubmitting, setErrors }) => {
        ...
        startTransition(
          async () =>
            await props.createNewMultipleOffer(
              values,
              base64Files,
              props.venueId
            )
...
export default NewMultipleOfferForm;
